...
export function ResumeUploadModal({ isOpen, onClose }: ResumeUploadModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Submitting resume:", { name, email, fileName: file.name })
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload your resume and we'll match you with opportunities that fit your skills and experience.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          ...
          <DialogFooter className="pt-4">
            ...
            <Button type="submit" disabled={isSubmitting || isSuccess} className="min-w-[100px]">
              {isSubmitting ? (
